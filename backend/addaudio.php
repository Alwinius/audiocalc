...
if(ctype_alnum($_COOKIE["username"]) && preg_match($namecheck, $_POST["name"]) && preg_match($durationcheck, $_POST["duration"]) && $_POST["duration"]!="00:00:00" && $_POST["duration"]!="0:00:00") {
